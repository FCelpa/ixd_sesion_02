...
var lorenIpsum = [" el café","los gatos","dormir"," el tiramisú","pintar"];
...
function portada() {
    createSpan("Estás en la portada.html").parent("title");
    createElement('p','Y me gusta mucho '+random(lorenIpsum)+' desde pequeña.').parent(loPrincipal);
